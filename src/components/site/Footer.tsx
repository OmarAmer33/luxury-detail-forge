      ...
      <div className="container-luxe grid gap-12 py-16 md:grid-cols-4">
        ...
        <div>
          ...
          <ul className="mt-6 space-y-3 text-sm text-muted-foreground">
            ...
            <li>
              <a href="mailto:info@topeliteauto.com" className="flex items-center gap-3 hover:text-[var(--color-gold)]" itemProp="email"><Mail size={16} className="text-[var(--color-gold)]" />info@topeliteauto.com</a>
